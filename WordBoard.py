...
class WordBoard:
    """
    WordBoard adalah GUI untuk aplikasi WordSearch. Kisi ditampilkan
    di sisi kiri aplikasi sebagai kisi tombol yang menangkap kata mana
    telah ditemukan. Sisi kanan GUI menampilkan menu yang memudahkan pengguna
    untuk melihat solusinya, atur ulang papan, atau buat papan baru dengan
    kata yang benar-benar baru (dipilih secara acak dari words.txt/file_name). Pengguna juga bisa
    ekspor papan saat ini sebagai file html yang berisi papan dalam html <table>,
    Bentuk LaTeX dan String. File ini juga berisi solusinya.
    """
    ...
    def __init__(self, size=16, color="yellow", file_name="words.txt", words=None):
        ...
        # "Solution" Button
        tk.Button(
            self._menu, text="Jawaban", padx=1, pady=1, command=self._solution
    ...
    def _create_labels(self):
        """
       Membuat/mengubah label kata di sisi kanan GUI.
        """
    ...
    def _pressed(self, row, col):
        """
        Perintah untuk setiap tombol di papan tulis. Cek untuk melihat apakah sebuah kata
        telah ditemukan dan menonaktifkan semua tombol yang terkait dengan kata satu kali
        ditemukan.
